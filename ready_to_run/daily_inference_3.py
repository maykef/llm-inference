...
class DailyInference:
    def __init__(self, model_id, load_in_4bit=False, load_in_8bit=False, repo_path=None):
        ...
        # ===================================================================
        # NEW: Detect bnb-4bit/Unsloth models and skip manual quantization config
        # ===================================================================
        ...
        # Load Model — skip quantization_config for pre-quantized bnb models
        if is_pre_quantized_bnb:
            ...
            self.model = AutoModelForCausalLM.from_pretrained(
                ...
                # No quantization_config — uses model's built-in
            )
        else:
            # Original path for non-pre-quantized models (unchanged)
            self.model = AutoModelForCausalLM.from_pretrained(
                self.model_id,
        ...
        # Sync pad token (works for both paths)
...
if __name__ == "__main__":
    ...
    # Safety check — skip warning for bnb-4bit or AWQ models
